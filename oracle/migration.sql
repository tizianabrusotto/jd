-- precondition: user me already created via setup script
--
-- run this script with SQL*Plus connected as me
...
create table departments(
	department_id integer generated by default on null as identity start with 10 increment by 10 primary key,
...
create table clients (
  client_id integer generated by default on null as identity primary key,
...
--
create table coders (
  coder_id integer generated by default as identity start with 201 primary key,
  first_name varchar2(20),
...
insert into coders (first_name, last_name, hire_date, salary) values ('Tim', 'Ice', sysdate, 5760);
...
--
create table teams(
	team_id integer generated by default on null as identity primary key,
